...
const articles = [
  ...
  },
  {
    ...
    date: "2026-02-10",
    image:
      "https://www.actualidadmotor.com/wp-content/uploads/2024/04/motor-f1-2026.jpg",
    content:
      "The grid is heating up with the new regulations. Red Bull vs Ferrari 2.0.",
  },
  ...
  },
  {
    ...
    content:
      "Eight people were tragically killed in an avalanche in the Austrian Alps. Emergency services were deployed to the Tyrol region.",
  },
  {
    category: "world",
    ...
    content:
      "World leaders gather to discuss the final push for net-zero by 2040.",
  },
  ...
  // --- POLITICS ---
  {
    ...
    content:
      "Get ready for the enemy, nasty chude invaders! Brussels is rethinking defense strategies.",
    editorPick: true,
  },
  {
    category: "politics",
    ...
    date: "2026-02-01",
    image:
      "https://heartland.org/wp-content/uploads/2025/09/WebstiteFeature2025Poll.png",
    content:
      "Voters are moving away from traditional party lines in record numbers.",
  },
  ...
  // --- TECH ---
  {
    ...
    date: "2026-02-14",
    image:
      "https://img.freepik.com/premium-photo/digital-human-interface_21085-93295.jpg",
    content:
      "Can algorithms write better stories than humans? We investigate the rise of AI journalism.",
  },
  {
    category: "tech",
    ...
    date: "2026-02-12",
    image:
      "https://telforcegroup.com/wp-content/uploads/2023/08/telforce-flipphone.png",
    content:
      "Minimalism is back. Why Gen Z is ditching smartphones for 'dumb' phones.",
  },
];
